<?php 
	...
	class Paginas extends Controllers{
		...
		public function paginas()
		{
            ...
            $data['page_title'] = '<i class="fas fa-user-tag"></i>'." PÁGINAS ";
        ...
        public function editar($idpost){
            ...
            if($idpost > 0){
                ...
                $data['page_title'] = "ACTUALIZAR PÁGINA <small>Oh my pet</small>";
        ...
        public function crear(){
            ...
            $data['page_title'] = "CREAR PÁGINA <small>Oh my pet</small>";
