      ...
      <div class="tile">
        ...
        ?>
          <section id="sPedido" class="invoice">
            <div class="row mb-4">
              <div class="col-6">
                <h2 class="page-header"><img src="<?= media(); ?>/images/img-paypal.jpg" alt="PAYPAL"></h2>
              </div>
              <?php if(!$reembolso){ 
            ...
            <div class="row invoice-info">
              <div class="col-4">
                <address>
                  <strong>Transaccion: <?= $idTransaccion; ?></strong><br>
              ...
              <div class="col-4">
                <address><strong>Enviado por:</strong><br><br>
                  ...
                  <strong>Direccion: </strong> <?= $direccion1; ?><br>
            ...
            <div class="row">
              <div class="col-12 table-responsive">
                ...
                <table class="table table-sm">
                  ...
                  <tbody>
                    <tr>
                      <td>Compra en OhMyPet! por <?= "$" . $monto ?></td>
